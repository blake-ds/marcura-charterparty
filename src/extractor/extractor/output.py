...
<div class="wrap">
  ...
  {body}
  <footer class="page">
    Wire-format JSON deliverable: <code>output/clauses.json</code>.
    Design write-up: <a href="../docs/site/index.html">docs/site/index.html</a>
    (or the markdown source-of-truth in <code>docs/</code>).
  </footer>
</div>
</body>
</html>
